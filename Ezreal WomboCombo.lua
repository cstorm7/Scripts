...
function OnUnload()
	PrintFloatText(myHero,2," WomboCombo UnLoaded!")
end
function LoadMenu()
	Config = scriptConfig(" WomboCombo", " WomboCombo")
	...
	PrintFloatText(myHero,2," WomboCombo Loaded!")
end
...
function checkDeath(target)
	if ValidTarget(target) and target == newTarget then
